// ==UserScript==
// @name          TPlink WDR7500 WEB-UI Traducción al Castellano
...
var dict_ch2eng = {
	...
	"设置向导":"Setup Wizard",
	"网络参数":"Parametros de Red",
		"WAN口设置":"Ajustes puerto WAN",
		"LAN口设置":"Ajustes puerto LAN",
		"WAN口速率/模式":"Puerto WAN Velocidad/Modo",
		"MAC地址克隆":"Clonación Direccción MAC",
	"无线频段设置":"Ajustes Wireless,
	"无线设置 2.4GHz":"Ajustes Banda 2.4GHz",
		"基本设置":"Ajustes Básicos",
		"QSS安全设置":"Ajustes de seguridad QSS",
		//Not neccesary 
		//"QSS安全设置":"QSS security settings2",
		"无线安全设置":"Ajustes de seguridad Wireless",
		"无线MAC地址过滤":"Filtro dirección MAC",
		"无线高级设置":"Ajustes Avanzados Wireless",
		"主机状态":"Estado del Host",
	"无线设置 5GHz":"Ajustes Banda 5GHz",
		// same as above
	"DHCP服务器":"Servidor DHCP",
		"DHCP服务":"Servicio DHCP",
		"客户端列表":"Lista de clientes",
		"静态地址分配":"Asignar dirección estática",
	"网络共享":"Compartir en Red",
		"网络共享管理":"Gestión Compartir en Red",
		"FTP服务器":"Servidor FTP",
		"媒体服务器":"Servidor Multimedia",
		"打印服务器":"Servidor de Impresión",
		"共享帐户":"Cuenta compartida",
	"NAT设置":"Ajustes NAT",
	"转发规则":"Reglas de reenvío",
		"虚拟服务器":"Servidor Virtual",
		"特殊应用程序":"Aplicaciones Especiales",
		"DMZ主机":"Host DMZ",
		"UPnP设置":"Ajustes UPnP",
	"安全功能":"Características de Seguridad",
		"安全设置":"Ajustes de Seguridad",
		"局域网WEB管理":"Gestión Web LAN",
		"远端WEB管理":"Gestión Web Remota",
	"家长控制":"Control ParentalParental Controls",
	"上网控制":"Control Acceso Internet",
		"规则管理":"Gestión de Reglas",
		"主机列表":"Lista Host",
		"访问目标":"Access target",
		"日程计划":"Schedule",
